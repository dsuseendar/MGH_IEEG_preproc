...
isiNatus = [diff(natusTrialStart(1:40)); diff(natusTrialStart(41:80)); diff(natusTrialStart(81:120))];
isiBeh = [diff(behTimingOnset(1:40)); diff(behTimingOnset(41:80)); diff(natusTrialStart(81:120))];
