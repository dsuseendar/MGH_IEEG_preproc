function [all_trial_timing,trial_based_frame] = extract_timing_for_langloc_audio_bits_switched(varargin)
...
% Define default values
    ...
    for i = 1:2:length(varargin)
        switch varargin{i}
            ...
            case 'sampling'
                sampling_frequency = varargin{i+1};
            case 'pre_start'
...
trial_start=trial_start_temp-.2*sampling_frequency;
trial_end_temp=find(diff(probe_bit.*expr_frame)==-1)+1;
trial_end=trial_end_temp+.2*sampling_frequency;
